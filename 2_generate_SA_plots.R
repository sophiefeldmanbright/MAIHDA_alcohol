...
# Read in data
plot_data <- readRDS(paste0(outputs,"grams drinkers/results_grams_drinkers_2010_2018.rds"))
...
# Plot additive versus total estimates, both genders together
...
combined_plot
ggsave(paste0(outputs,"grams drinkers/plot grams both sexes, additive versus total estimates_2010_2018.png"), dpi=1200, width=33, height=19, units="cm")
