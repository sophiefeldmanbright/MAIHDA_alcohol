...
# Plot of additive versus total estimates
...
combined_plot
ggsave(paste0(outputs,"grams drinkers/plot grams both sexes, additive versus total estimates.png"), dpi=1200, width=33, height=19, units="cm")
